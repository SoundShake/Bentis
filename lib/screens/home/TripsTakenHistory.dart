...
class TripsGivenHistory extends StatefulWidget {
  const TripsGivenHistory({Key? key}) : super(key: key);
  @override
  State<TripsGivenHistory> createState() => _TripsGivenHistory();
}

class _TripsGivenHistory extends State<TripsGivenHistory>{
  @override
